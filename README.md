...
This will start a Tabris.js code server at a free port and print its URL to the console. The app code can then be [side-loaded](https://tabrisjs.com/documentation/3.0/developer-app.html#run-your-app) in the [developer app](https://tabrisjs.com/documentation/3.0/developer-app.html) by entering that URL.
...
See [Building a Tabris.js App](https://tabrisjs.com/documentation/3.0/build.html) for more information.
